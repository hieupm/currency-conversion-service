...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversionFeign(@PathVariable String from,
        ...
        return new CurrencyConversion(currencyConversion.getId(), from, to, currencyConversion.getConversionMultiple(), quantity, currencyConversion.getEnvironment() + " feign", quantity.multiply(currencyConversion.getConversionMultiple()));
    }
}
